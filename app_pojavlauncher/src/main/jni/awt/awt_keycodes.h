...
#ifndef POJAVLAUNCHER_AWT_KEYCODES_H
#define POJAVLAUNCHER_AWT_KEYCODES_H

#define BUTTON1_DOWN_MASK (1 << 10)
#define BUTTON2_DOWN_MASK (1 << 11)
#define BUTTON3_DOWN_MASK (1 << 12)
...
#define VK_BEGIN                    0xFF58

#define VK_UNDEFINED      0x0

#endif //POJAVLAUNCHER_AWT_KEYCODES_H
