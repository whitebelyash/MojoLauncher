...
public class MoJsonExtras {
    public static String normalizeVersionId(String versionString) {
        ...
        if (Instance.VERSION_LATEST_RELEASE.equals(versionString))
            versionString = versionList.latest.get("release");
        if (Instance.VERSION_LATEST_SNAPSHOT.equals(versionString))
            versionString = versionList.latest.get("snapshot");
    ...
    public static JVersionList.Version getListedVersion(String normalizedVersionString) {
        ...
        if (versionList == null || versionList.versions == null)
            return null; // can't have listed versions if there's no list
